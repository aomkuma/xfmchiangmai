...
export class MediaStreamServiceProvider {
  ...
  private streamUrl = {streamHttp: 'http://stream.xfmnetwork.com:8613/', streamPort:'http://stream.xfmnetwork.com:8613'}
  private defaultStreamQuality = 'mp3';
  ...
  private checkPlatform(){
    if(this.platform.is('core')||this.platform.is('mobileweb')){
      ...
      console.log(this.streamUrl.streamHttp);
  ...
  private setStreamSource(src:string){
    console.log(this.streamUrl.streamHttp+src);
  ...
  private refreshStreamMeta(station) {
    console.log('refresh stream meta');
