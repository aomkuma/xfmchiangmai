...
const stations = {
    'pop':[
      new Station('','Power 181 (Top 40)',8613),
      new Station('181-oldschool','Old School HipHop/RnB',8613),
      new Station('181-uktop40','UK Top 40',8613),
      new Station('181-vibe','The Vibe of Vegas',8613)
    ],
    'rock':[
